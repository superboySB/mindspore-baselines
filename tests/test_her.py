...
from mindspore_baselines import DDPG, DQN, SAC, TD3, HerReplayBuffer
from mindspore_baselines.common.envs import BitFlippingEnv
from mindspore_baselines.common.evaluation import evaluate_policy
from mindspore_baselines.common.monitor import Monitor
from mindspore_baselines.common.noise import NormalActionNoise
from mindspore_baselines.common.vec_env import DummyVecEnv
from mindspore_baselines.her.goal_selection_strategy import GoalSelectionStrategy
from mindspore_baselines.her.her_replay_buffer import get_time_limit


def test_import_error():
    with pytest.raises(ImportError) as excinfo:
        from mindspore_baselines import HER
